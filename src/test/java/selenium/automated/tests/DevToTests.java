...
public class DevToTests {
    ...
    public void SetUp(){ //pre-requirements - warunki początkowe
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\hp\\Documents\\Kurs Testera Oprogramowania\\chromedriver.exe"); //ścieżka do chromedriver
    ...
    public void OpenDevTo(){
        ...
        //na ten moment, mamy otworzoną stronę dev.to - żeby sprawdzić, czy faktycznie na niej jesteśmy, chcemy porównać url ze zmiennej wcześniejszej do obecnego url z przegladarki

        String currentUrl = driver.getCurrentUrl(); //wyciągamy obecny url z przeglądarki i przypisujemy go do zmiennej currentUrl

        //assertTrue - sprawdza poprawność warunku url.equals(currentUrl) - czy url ze zmiennej url jest taki sam jak w zmiennej currentUrl jeśli nie - wpisuje message "The current url isn`t dev.to", i ustawia test na fail
